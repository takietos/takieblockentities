...
public class PearVineBlock extends TallPlantBlock implements Fertilizable {
    ...
    public PearVineBlock(RegistryKey<ConfiguredFeature<?, ?>> tree, Settings settings) {
        super(settings);
        this.tree = tree;
    }
    public PearVineBlock(Settings settings) {
        super(settings.ticksRandomly());
        this.tree = TakieTerraConfiguredFeatures.HUGE_PEAR;
    }
    ...
    public boolean canGrow(World world, Random random, BlockPos pos, BlockState state) {
        ...
        return dirt.isIn(TakieTerraTags.Blocks.PEAR_GROWABLE_ON);
    }
