...
public class WhiteStrawberryBushBlock extends PlantBlock
    ...
    public WhiteStrawberryBushBlock(Settings settings) {
        super(settings);
    ...
    public ItemStack getPickStack(BlockView world, BlockPos pos, BlockState state) {
        return new ItemStack(TakieTerraItems.STRAWBERRY_WHITE);
    }
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockHitResult hit) {
        ...
        if (i > 1) {
            ...
            SweetBerryBushBlock.dropStack(world, pos, new ItemStack(TakieTerraItems.STRAWBERRY_WHITE, j + (bl ? 1 : 0)));
