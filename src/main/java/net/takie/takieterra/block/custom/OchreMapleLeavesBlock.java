...
public class OchreMapleLeavesBlock
        extends LeavesBlock {
    public OchreMapleLeavesBlock(Settings settings) {
        super(settings);
    }
    ...
    public void randomDisplayTick(BlockState state, World world, BlockPos pos, Random random) {
        ...
        ParticleUtil.spawnParticle(world, pos, random, TakieTerraParticles.ORANGE_MAPLE_LEAVES_PARTICLE);
    }
}
