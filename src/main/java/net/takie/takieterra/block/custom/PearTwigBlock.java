...
public class PearTwigBlock extends PlantBlock implements Fertilizable {
    public static final int MAX_AGE = 7;
    public static final IntProperty AGE = Properties.AGE_7;
    protected static final VoxelShape SHAPE = Block.createCuboidShape(5.0D, 0.0D, 5.0D, 11.0D, 8.0D, 11.0D);

    public PearTwigBlock(AbstractBlock.Settings settings) {
    ...
    public void grow(ServerWorld world, Random random, BlockPos pos, BlockState state) {
        if (state.get(AGE) < MAX_AGE){
            ...
            world.setBlockState(pos, PearBlocks.PEAR_SAPLING.getDefaultState());
        }
    }
}