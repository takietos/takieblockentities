...
public class SwampSylphLeaves extends LeavesBlock implements Fertilizable {
    public SwampSylphLeaves(Settings properties) {
        super(properties);
    }
    ...
    public boolean isFertilizable(@NotNull WorldView levelReader, @NotNull BlockPos blockPos, @NotNull BlockState blockState, boolean bl) {
        Block vineBlock = TakieTerraTreeBlocks.SWAMP_SYLPH_VINES;
        Block vineBlock2 = TakieTerraTreeBlocks.SWAMP_SYLPH_VINES_PLANT;
