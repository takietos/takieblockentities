...
public class TitaniumQuartzClusterBlock extends AmethystBlock
    ...
    public TitaniumQuartzClusterBlock(int height, int xzOffset, AbstractBlock.Settings settings) {
        super(settings);
