...
public class YellowAutumnLeavesBlock
        extends LeavesBlock {
    public YellowAutumnLeavesBlock(Settings settings) {
        super(settings);
    }
    ...
    public void randomDisplayTick(BlockState state, World world, BlockPos pos, Random random) {
        ...
        ParticleUtil.spawnParticle(world, pos, random, TakieTerraParticles.YELLOW_AUTUMN_PARTICLE);
    }
}