...
public class KettleBlock extends BlockWithEntity {
    ...
    public VoxelShape getOutlineShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context) {
        return Block.createCuboidShape(3,0,3,10,11,10);
    }

    public KettleBlock(Settings settings) { super(settings); }
    ...
    public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state,
        ...
        return checkType(type, TakieTerraBlockEntities.KETTLE_BLOCK_ENTITY, KettleBlockEntity::tick);
    }
}
