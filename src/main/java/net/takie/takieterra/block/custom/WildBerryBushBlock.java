...
public class WildBerryBushBlock extends PlantBlock
    ...
    public WildBerryBushBlock(AbstractBlock.Settings settings) {
        super(settings);
    ...
    public ItemStack getPickStack(BlockView world, BlockPos pos, BlockState state) {
        return new ItemStack(TakieTerraItems.RASPBERRY);
    }
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockHitResult hit) {
        ...
        if (i > 1) {
            ...
            SweetBerryBushBlock.dropStack(world, pos, new ItemStack(TakieTerraItems.RASPBERRY, j + (bl ? 1 : 0)));
