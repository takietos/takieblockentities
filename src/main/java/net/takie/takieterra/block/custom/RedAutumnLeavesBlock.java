...
public class RedAutumnLeavesBlock
        extends LeavesBlock {
    public RedAutumnLeavesBlock(Settings settings) {
        super(settings);
    }
    ...
    public void randomDisplayTick(BlockState state, World world, BlockPos pos, Random random) {
        ...
        ParticleUtil.spawnParticle(world, pos, random, TakieTerraParticles.RED_AUTUMN_PARTICLE);
    }
}