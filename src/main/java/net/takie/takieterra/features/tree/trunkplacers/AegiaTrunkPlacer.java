...
public class AegiaTrunkPlacer extends TrunkPlacer {
	public static final Codec <AegiaTrunkPlacer> CODEC = RecordCodecBuilder.create((instance) -> {
		...
		}))).apply(instance, AegiaTrunkPlacer::new);
	});
	...
	public AegiaTrunkPlacer(int baseHeight, int firstRandomHeight, int secondRandomHeight, IntProvider extraBranchSteps, float placeBranchPerLogProbability, IntProvider extraBranchLength, RegistryEntryList <Block> canGrowThrough) {
	...
	protected TrunkPlacerType <?> getType() {
		return TakieTerraTrunkPlacerTypes.AEGIA_TRUNK_PLACER_TYPE;
	}
