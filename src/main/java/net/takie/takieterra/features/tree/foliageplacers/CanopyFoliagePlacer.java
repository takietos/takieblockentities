...
public class CanopyFoliagePlacer extends FoliagePlacer {
	...
	protected FoliagePlacerType<?> getType() {
		return TakieTerraFoliagePlacerTypes.CANOPY;
	}
	...
	protected void generate(TestableWorld world, BiConsumer<BlockPos, BlockState> replacer, Random random, TreeFeatureConfig config, int trunkHeight, TreeNode treeNode, int foliageHeight, int offset) {

		int radius = treeNode.getFoliageRadius();
