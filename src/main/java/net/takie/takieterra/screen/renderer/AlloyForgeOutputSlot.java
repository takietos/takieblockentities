...
public class AlloyForgeOutputSlot extends Slot {
    ...
    protected void onCrafted(ItemStack stack) {
        ...
        if (this.player instanceof ServerPlayerEntity && this.inventory instanceof AlloyForgeBlockEntity) {
            ((AlloyForgeBlockEntity)this.inventory).dropExperienceForRecipesUsed((ServerPlayerEntity)this.player);
        }
